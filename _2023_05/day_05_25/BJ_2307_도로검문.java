package com.ssafy._2023_05.day_05_25;
...
//
//            // 모든 정점의 연결관계를 확인하여 검문소로 적용해보고 최소시간을 구한다.
//            for (Node node : nodes) {
//                int p_end = node.idx;
//
//                if (route[i] != 0) {
...
//        System.out.println(max_delay + ", " + Integer.MAX_VALUE);
        if (max_delay == Integer.MAX_VALUE) {
